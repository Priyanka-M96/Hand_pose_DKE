...
def load_inference_graph():
    ...
    #sg.popup_quick_message('> ====== loading HAND frozen graph into memory', background_color='red',text_color='white')
    detection_graph = tf.Graph()
    ...
    #sg.popup_quick_message('>  ====== Hand Inference graph loaded.', background_color='red',text_color='white')
