...
if __name__ == "__main__":
    ...
    # Fist
    print('<< FIST >>')
    im = cv2.imread("F:/Github/HandPose/Poses/Fist/Fist_1/Fist_1_1302.png")
    print(test_classify(model, im))

    # # Dang
    # print('<< DANG >>')
    # im = cv2.imread("F:/Github/HandPose/Poses/Dang/Dang_1/Dang_1_1223.png")
    # print(test_classify(model, im))
    #
    # # Four
    # print('<< FOUR >>')
    # im = cv2.imread("F:/Github/HandPose/Poses/Four/Four_1/Four_1_867.png")
    # print(test_classify(model, im))
    #
    # # Startrek
    # print('<< Startrek >>')
    # im = cv2.imread("F:/Github/HandPose/Poses/Startrek/Startrek_1/Startrek_1_867.png")
    # print(test_classify(model, im))

    # Palm
    print('<< Palm >>')
    im = cv2.imread("F:/Github/HandPose/Poses/Palm/Palm_1/Palm_1_867.png")
    print(test_classify(model, im))